...
export const colors = {
	...
	data: {
		...
		variants: {
			...
			mu: multiseries.magenta_dark,
			nu: multiseries.magenta_dark,
			xi: multiseries.magenta_dark,
			omicron: multiseries.magenta_dark,
			pi: multiseries.magenta_dark,
			rho: multiseries.magenta_dark,
			sigma: multiseries.magenta_dark,
			tau: multiseries.magenta_dark,
			upsilon: multiseries.magenta_dark,
			phi: multiseries.magenta_dark,
