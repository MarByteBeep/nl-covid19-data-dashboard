			...
			<NlLayout>
				<TileList>
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								difference={
									data.difference.deceased_rivm__covid_daily
								}
								isAmount
							/>
							<Markdown
					...
					<PageInformationBlock
						...
						icon={<Coronavirus />}
						description={
							siteText.section_sterftemonitor.description
						}
						referenceLink={
							siteText.section_sterftemonitor.reference.href
						}
						metadata={{
							...
							dataSources: [
								siteText.section_sterftemonitor.bronnen.cbs,
							],
						}}
