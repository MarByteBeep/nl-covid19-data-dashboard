				...
				<TileList>
					<PageInformationBlock
						...
						metadata={{
							...
							dateOfInsertionUnix:
								elderlyAtHomeData.last_value
									.date_of_insertion_unix,
							dataSources: [
								text.section_positive_tested.bronnen.rivm,
							],
						}}
						referenceLink={
							text.section_positive_tested.reference.href
						}
					...
					<TwoKpiSection>
						<KpiTile
							...
							metadata={{
								...
								source: text.section_positive_tested.bronnen
									.rivm,
							}}
						>
							<KpiValue
					...
					<ChartTile
						...
						title={
							text.section_positive_tested.line_chart_daily_title
						}
						metadata={{
								...
								seriesConfig={[
									{
										...
										label: text.section_positive_tested
					...
					<ChoroplethTile
						title={
							text.section_positive_tested.choropleth_daily_title
						}
						description={
							text.section_positive_tested
						...
						legend={{
							thresholds:
								thresholds.vr.positive_tested_daily_per_100k,
							title: text.section_positive_tested
								.choropleth_daily_legenda,
						}}
					>
						<DynamicChoropleth
							renderTarget="canvas"
					...
					<TwoKpiSection>
						<KpiTile
							...
							description={
								text.section_deceased.kpi_daily_description
							}
							metadata={{
								date: elderlyAtHomeData.last_value.date_unix,
						...
						>
							<KpiValue
								...
								absolute={
									elderlyAtHomeData.last_value.deceased_daily
								}
							/>
						</KpiTile>
					</TwoKpiSection>
					...
					<ChartTile
						...
						description={
							text.section_deceased.line_chart_daily_description
						}
					>
						{(timeframe) => (
							<TimeSeriesChart
