				...
				<TileList>
					<PageInformationBlock
						...
						screenReaderCategory={
							siteText.sidebar.metrics.intensive_care_admissions
								.title
						}
						title={text.titel}
						icon={<Arts />}
						...
						metadata={{
							...
							dateOfInsertionUnix:
								dataIntake.last_value.date_of_insertion_unix,
						...
						>
							...
							<Markdown
								content={replaceVariablesInText(
									text.extra_uitleg,
									{
										dateStart: formatDateFromSeconds(
											sevenDayAverageDates[0]
										),
										dateEnd: formatDateFromSeconds(
											sevenDayAverageDates[1]
										),
									}
								)}
							/>
							...
							{bedsLastValue.beds_occupied_covid !== null &&
								bedsLastValue.beds_occupied_covid_percentage !==
									...
									<>
										<PageBarScale
											value={
												bedsLastValue.beds_occupied_covid
											}
						...
						{(timeframe) => (
							<TimeSeriesChart
								...
								dataOptions={{
									timespanAnnotations: [
										{
											start: data.intensive_care_lcps
												.values[0].date_unix,
											end:
												new Date(
													'1 June 2020'
												).getTime() / 1000,
											label: text.chart_bedbezetting
												.legend_inaccurate_label,
											shortLabel:
												siteText.common.incomplete,
										},
									],
					...
					<ChartTile
						...
						description={
							siteText.ic_admissions_per_age_group
								.chart_description
						}
						timeframeOptions={['all', '5weeks']}
						timeframeInitialValue="5weeks"
					...
					>
						{(timeframe) => (
							<AdmissionsPerAgeGroup
								...
								values={
									data.intensive_care_nice_per_age_group
										.values
								}
								timeframe={timeframe}
							/>
