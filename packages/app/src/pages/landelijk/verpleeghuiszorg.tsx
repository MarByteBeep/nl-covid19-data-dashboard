				...
				<TileList>
					<PageInformationBlock
						...
						metadata={{
							...
							dataSources: [
								positiveTestedPeopleText.bronnen.rivm,
							],
						}}
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								absolute={
									nursinghomeDataLastValue.newly_infected_people
								}
								difference={
									data.difference
					...
					<ChartTile
						...
						description={
							positiveTestedPeopleText.linechart_description
						}
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								absolute={
									nursinghomeDataLastValue.infected_locations_total
								}
								percentage={
						...
						>
							<KpiValue
								...
								absolute={
									nursinghomeDataLastValue.newly_infected_locations
								}
							/>
							<Text>
								{infectedLocationsText.barscale_toelichting}
							</Text>
						</KpiTile>
					</TwoKpiSection>
					...
					<ChoroplethTile
						...
						legend={{
							thresholds:
								thresholds.vr.infected_locations_percentage,
							title: infectedLocationsText.chloropleth_legenda
								.titel,
						}}
					>
						<DynamicChoropleth
					...
					<ChartTile
						...
						timeframeOptions={['all', '5weeks']}
						description={
							infectedLocationsText.linechart_description
						}
					>
						{(timeframe) => (
							<TimeSeriesChart
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								absolute={
									nursinghomeDataLastValue.deceased_daily
								}
							/>
						</KpiTile>
					</TwoKpiSection>
