				...
				<TileList>
					<PageInformationBlock
						...
						screenReaderCategory={
							siteText.sidebar.metrics.disabled_care.title
						}
								...
								seriesConfig={[
									{
										...
										label: positiveTestedPeopleText.line_chart_newly_infected_people_moving_average,
										shortLabel:
								...
								seriesConfig={[
									{
										...
										label: locationDeaths.line_chart_deceased_daily_moving_average,
										shortLabel:
