...
export const getStaticProps = createGetStaticProps(
	...
	createGetChoroplethData({
		vr: ({ tested_overall, vaccine_coverage_per_age_group }) => ({
			tested_overall,
			vaccine_coverage_per_age_group: isDefined(
					...
					>
						<Box spacing={3}>
							...
							<MiniTileSelectorLayout
								...
								menuItems={[
									{
										label: siteText.nationaal_actueel
											.mini_trend_tiles.ic_opnames
											.menu_item_label,
										data: trimNullValues(
											dataICTotal.values,
											'admissions_on_date_of_admission_moving_average_rounded'
							...
							>
								<MiniTrendTile
									title={
										text.mini_trend_tiles.ic_opnames.title
									}
									text={
										<>
											<DataDrivenText
									...
									seriesConfig={[
										{
											...
											label: siteText.ic_opnames_per_dag
									...
									accessibility={{
										key: 'topical_intensive_care_nice',
									}}
									warning={getWarning(
										content.elements.warning,
										'intensive_care_nice'
						...
						<VaccinationCoverageChoropleth
							title={
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.title.nl
							}
							content={
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.content.nl
							}
							data={{
								gm: choropleth.gm
									.vaccine_coverage_per_age_group,
							...
							link={{
								...
								text: siteText.common_actueel.secties
									.vaccination_coverage_choropleth.link_text
									.nl,
							}}
						/>
					</Box>
