			...
			<Box bg="white">
					...
					>
						<Box spacing={3}>
							...
							<MiniTileSelectorLayout
								...
								menuItems={[
									{
										label: siteText.gemeente_actueel
											.mini_trend_tiles.ziekenhuis_opnames
											.menu_item_label,
										data: trimNullValues(
									...
									{
										label: siteText.gemeente_actueel
											.mini_trend_tiles.vaccinatiegraad
											.menu_item_label,
										data: data
											.vaccine_coverage_per_age_group
											.values,
										...
										value: renderedAgeGroup18Pluslabels.fully_vaccinated_percentage,
										...
										percentageBar: {
											value:
												...
												null,
											label: filteredAgeGroup18Plus?.fully_vaccinated_percentage_label,
										},
								...
								<MiniTrendTile
									...
									text={
										<>
												...
												content={[
													{
														...
														additionalData: {
															dateStart:
																formatters.formatDateFromSeconds(
											...
											/>
											<LinkWithIcon
												href={reverseRouter.gm.ziekenhuisopnames(
													gmCode
												)}
												icon={<Chevron />}
												iconPlacement="right"
									...
									<MiniVaccinationCoverageTile
										...
										text={
											<>
												...
												<LinkWithIcon
													href={reverseRouter.gm.vaccinaties(
														gmCode
													)}
													icon={<Chevron />}
													iconPlacement="right"
						...
						<Box pt={4}>
							<Search
								title={
									siteText.common_actueel.secties.search.title
										.gm
								}
							/>
						</Box>
						...
						<VaccinationCoverageChoropleth
							title={replaceVariablesInText(
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.title.gm,
								{ municipalityName: municipalityName }
							)}
							content={replaceVariablesInText(
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.content.gm,
								{ municipalityName: municipalityName }
							)}
							gmCode={gmCode}
							data={{
						...
						<CollapsibleButton
							label={
								siteText.common_actueel.overview_links_header
							}
						>
							<Sitemap
								...
								quickLinks={[
									...
									},
									{
										href: reverseRouter.vr.index(
											vrForMunicipality.code
										),
										text: replaceVariablesInText(
											text.quick_links.links
												.veiligheidsregio,
											{
												safetyRegionName:
													vrForMunicipality.name,
											}
										),
									},
									{
				...
				<Box width="100%" backgroundColor="offWhite" pb={5}>
					...
					>
						<TopicalSectionHeader
							title={
								siteText.common_actueel.secties.meer_lezen.titel
							}
							description={
								siteText.common_actueel.secties.meer_lezen
									.omschrijving
							}
							link={
								siteText.common_actueel.secties.meer_lezen.link
							}
							headerVariant="h2"
						/>
