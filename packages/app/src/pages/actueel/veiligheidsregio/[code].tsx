					...
					>
						<Box spacing={3}>
							...
							<MiniTileSelectorLayout
								...
								menuItems={[
									{
										label: siteText.veiligheidsregio_actueel
								...
								<MiniTrendTile
									...
									text={
										<>
											...
											/>
											<LinkWithIcon
												href={reverseRouter.vr.ziekenhuisopnames(
													vrCode
												)}
												icon={<Chevron />}
												iconPlacement="right"
									...
									<MiniVaccinationCoverageTile
										...
										text={
											<>
												...
												<LinkWithIcon
													href={reverseRouter.vr.vaccinaties(
														vrCode
													)}
													icon={<Chevron />}
													iconPlacement="right"
						...
						<VaccinationCoverageChoropleth
							title={replaceVariablesInText(
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.title.vr,
								{ safetyRegion: vrName }
							)}
							content={replaceVariablesInText(
								siteText.common_actueel.secties
									.vaccination_coverage_choropleth.content.vr,
								{ safetyRegion: vrName }
							)}
							vrCode={vrCode}
							data={{
