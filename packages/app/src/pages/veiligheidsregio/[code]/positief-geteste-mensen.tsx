...
const PositivelyTestedPeople = (props: StaticProps<typeof getStaticProps>) => {
	...
	const selectedMunicipalCode = municipalCodes
		? municipalCodes[0]
		: undefined;
				...
				<TileList>
					<PageInformationBlock
						...
						screenReaderCategory={
							siteText.sidebar.metrics.positive_tests.title
						}
						...
						metadata={{
							...
							dateOfInsertionUnix:
								dataOverallLastValue.date_of_insertion_unix,
						...
						>
							<Box spacing={3}>
								...
								<Box>
									...
									<Markdown
										content={ggdText.summary_link_cta}
									/>
								</Box>
							</Box>
						</KpiTile>
					...
					<ChoroplethTile
						...
						legend={{
							title: siteText.positief_geteste_personen
								.chloropleth_legenda.titel,
					...
					<PageInformationBlock
						...
						metadata={{
							...
							dateOfInsertionUnix:
								dataGgdLastValue.date_of_insertion_unix,
							...
							<TimeSeriesChart
								...
								seriesConfig={[
									...
									},
									{
										...
										label: siteText
											.positief_geteste_personen
											.tooltip_labels.infected_percentage,
									},
								]}
								dataOptions={{
									isPercentage: true,
								...
								seriesConfig={[
									{
										...
										label: ggdText.linechart_totaltests_legend_label_moving_average,
										shortLabel:
									...
									},
									{
										...
										color: colors.data.primary,
										label: ggdText.linechart_positivetests_legend_label_moving_average,
										shortLabel:
											siteText.positief_geteste_personen
												.tooltip_labels
												.infected_moving_average,
