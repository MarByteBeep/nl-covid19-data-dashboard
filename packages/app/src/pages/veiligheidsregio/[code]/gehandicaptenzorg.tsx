...
const DisabilityCare = (props: StaticProps<typeof getStaticProps>) => {
	...
	const mortalityText =
		siteText.veiligheidsregio_gehandicaptenzorg_oversterfte;
			...
			<VrLayout vrName={vrName}>
				<TileList>
					...
					<ChartTile
						...
						description={
							positiveTestPeopleText.linechart_description
						}
					>
						{(timeframe) => (
							<TimeSeriesChart
								...
								seriesConfig={[
									{
										...
										label: positiveTestPeopleText.line_chart_newly_infected_people_moving_average,
										shortLabel:
								...
								seriesConfig={[
									{
										...
										label: mortalityText.line_chart_deceased_daily_moving_average,
										shortLabel:
