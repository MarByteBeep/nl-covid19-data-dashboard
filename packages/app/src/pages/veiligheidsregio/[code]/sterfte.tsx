				...
				<TileList>
					<PageInformationBlock
						...
						title={replaceVariablesInText(
							text.section_deceased_rivm.title,
							{
								safetyRegion: vrName,
							}
						)}
						...
						referenceLink={
							text.section_deceased_rivm.reference.href
						}
						metadata={{
							datumsText: text.section_deceased_rivm.datums,
							dateOrRange: dataRivm.last_value.date_unix,
							dateOfInsertionUnix:
								dataRivm.last_value.date_of_insertion_unix,
							dataSources: [
								text.section_deceased_rivm.bronnen.rivm,
							],
						}}
					...
					<TwoKpiSection>
						<KpiTile
							title={
								text.section_deceased_rivm.kpi_covid_daily_title
							}
							metadata={{
						...
						<KpiTile
							title={
								text.section_deceased_rivm.kpi_covid_total_title
							}
							metadata={{
								date: dataRivm.last_value.date_unix,
								source: text.section_deceased_rivm.bronnen.rivm,
								...
								seriesConfig={[
									{
										...
										label: text.section_deceased_rivm
					...
					<PageInformationBlock
						...
						icon={<Coronavirus />}
						description={
							siteText.section_sterftemonitor_vr.description
						}
						referenceLink={
							siteText.section_sterftemonitor_vr.reference.href
						}
						metadata={{
							datumsText:
								siteText.section_sterftemonitor_vr.datums,
							dateOrRange: {
								start: dataCbs.last_value.date_start_unix,
								end: dataCbs.last_value.date_end_unix,
							},
							dateOfInsertionUnix:
								dataCbs.last_value.date_of_insertion_unix,
							dataSources: [
								siteText.section_sterftemonitor_vr.bronnen.cbs,
							],
						}}
					/>
