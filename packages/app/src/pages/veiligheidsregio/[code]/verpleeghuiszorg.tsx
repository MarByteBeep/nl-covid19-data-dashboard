				...
				<TileList>
					<PageInformationBlock
						...
						title={replaceVariablesInText(
							positiveTestedPeopleText.titel,
							{
								safetyRegion: vrName,
							}
						)}
						...
						metadata={{
							...
							dateOfInsertionUnix:
								nursinghomeLastValue.date_of_insertion_unix,
							dataSources: [
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								absolute={
									nursinghomeLastValue.infected_locations_total
								}
								percentage={
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								...
								difference={
									data.difference.nursing_home__deceased_daily
								}
								isAmount
							/>
						</KpiTile>
