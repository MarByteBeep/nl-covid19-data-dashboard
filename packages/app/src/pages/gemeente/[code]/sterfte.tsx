				...
				<TileList>
					<PageInformationBlock
						...
						metadata={{
							...
							dateOrRange:
								data.deceased_rivm.last_value.date_unix,
							dateOfInsertionUnix:
								data.deceased_rivm.last_value
					...
					<TwoKpiSection>
						...
						>
							<KpiValue
								data-cy="covid_daily"
								absolute={
									data.deceased_rivm.last_value.covid_daily
								}
								difference={
						...
						>
							<KpiValue
								data-cy="covid_total"
								absolute={
									data.deceased_rivm.last_value.covid_total
								}
							/>
							<Text>
								{
