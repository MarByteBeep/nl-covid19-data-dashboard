	...
	if (base === 'gm' && code) {
		return [
			...
			},
			{
				...
				links: [
					{
						text: siteText.sidebar.metrics.hospital_admissions
							.title,
	...
	return [
		...
		},
		{
			...
			links: [
				...
				{
					text: siteText.sidebar.metrics.intensive_care_admissions
						.title,
		...
		},
		{
			...
			links: [
				...
				{
					text: siteText.sidebar.metrics
						.general_practitioner_suspicions.title,
