...
export function createDataConfig<T extends ChoroplethDataItem>(
	...
	return {
		...
		highlightStroke:
			partialDataConfig.highlightStroke ??
			colors.choroplethHighlightStroke,
		highlightStrokeWidth:
			partialDataConfig.highlightStrokeWidth ??
			DEFAULT_HOVER_STROKE_WIDTH,
		areaStroke:
			partialDataConfig.areaStroke ?? colors.choroplethFeatureStroke,
		areaStrokeWidth:
			partialDataConfig.areaStrokeWidth ?? DEFAULT_STROKE_WIDTH,
	};
}
