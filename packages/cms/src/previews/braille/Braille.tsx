		...
		<div className={styles.wrapper}>
			...
			<p className={styles.disclaimer}>
				<small>
					...
					, and only useful for sighted people to get an impression of
					it will look like. For this to be actually useful for people
					who can read it, the component has to be connected to a
					Braille tablet. There are efforts bringing JavaScript, IoT,
