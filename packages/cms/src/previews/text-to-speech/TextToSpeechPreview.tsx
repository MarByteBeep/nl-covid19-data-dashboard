...
class TextToSpeechPreview extends React.Component<any> {
	...
	render() {
		if (!speechSynth) {
			return (
				<div className={styles.wrapper}>
					Unfortunately your browser does not support the Web Speech
					API.
				</div>
			);
		}
		...
		return (
			<div className={styles.wrapper}>
				The <code>options</code> constant defines which fields can be
				uttered. Make sure the current document has a value for these
				fields.
			</div>
		);
	}
